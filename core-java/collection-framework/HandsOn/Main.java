...
public class Main {
    ...
    private static void listStudentsInCourse() {
        ...
        List<Student> students = registrationService.listStudentsInCourse(courseId);
        if (students.isEmpty()) {
    ...
    private static void listStudentsByBranch() {
        ...
        List<Student> students = registrationService.listStudentsByBranchInAllCourses(branch);
        if (students.isEmpty()) {
